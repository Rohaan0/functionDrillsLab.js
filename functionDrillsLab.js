...
let nameGreet = nameCheck('Rohaan')
...
console.log(bestMovie('The Spongebob Squarepants Movie'))
...
let newEmail = '        dfsakfdsdahklj' + 123 + 'gma@oil.com      '

console.log(emailCheck(newEmail))
////////////////// PROBLEM 19 ////////////////////
/*
...
function buyRandom(amount){
  t = amount / chocolateFrog
  return 'you were able to purchase a total of ' + t + ' chocolate frogs!';
}

totalFrogs = buyRandom(51)
...
function buyRandom2(amount){
  t = amount / chocolateFrog
  return 'you were able to purchase a total of ' + Math.round(t) + ' chocolate frogs!';
}

totalFrogs2 = buyRandom2(4)
...
arrayIsAscending = arrayChecker(sampleArray)
